        ...
        oTable = $('#tbl-list').DataTable({
           ...
           // "autoWidth": true, 
            columns: [
                ...
                { title: "PARENT LOV ID", width: "100px" },
                {
                    title: "LOV CODE",
                    width: "100px",
                    className: "tx-center"
                },
                { title: "LOV 1", width: "200px" },
                { title: "LOV 2", width: "200px" },
                { title: "LOV 3", width: "200px" },
                { title: "LOV 4", width: "200px" },
                { title: "LOV 5", width: "200px" },
                { title: "LOV 6", width: "200px" },
                { title: "LOV 7", width: "200px" },
                { title: "LOV 8", width: "200px"},
                { title: "LOV 9", width: "200px" },
                { title: "LOV 10", width: "200px" },
                { title: "LOV NOTE", width: "200px" },
                { title: "LOV ORDER", width: "80px" },
                {
                    title: "ACTIVE FLAG",
                    width: "100px",
