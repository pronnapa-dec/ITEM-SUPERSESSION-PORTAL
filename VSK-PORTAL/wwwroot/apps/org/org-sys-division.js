...
const url_auth_sys_division_create = url_api + '/v2/OrgSysDivisionCreate';
const url_auth_sys_division_update = url_api + '/v2/OrgSysDivisionUpdate';
const url_auth_sys_division_delete = url_api + '/v2/OrgSysDivisionDelete';
const url_auth_sys_division_get = url_api +'/v2/OrgSysDivisionGet';
...
firebase.auth().onAuthStateChanged(async function (user) {
    ...
    if (user) {
        ...
        $.List = async function () {
            ...
            let url = new URL(url_auth_sys_division_get);
            ...
            fetch(url).then(function (response) {
                ...
                $.each(result.data, function (key, val) {
                    ...
                    data.push([
                        ...
                        val['division_id'],
                        val['division_code'],
                        val['division_name_th'],
                        val['division_name_en'],
                        val['record_status']
                    ]);
                    ...
                    "initComplete": function (settings, json) {
                        $.contextMenu({
                            ...
                            callback: async function (key, options) {
                                ...
                                let citem = {
                                    division_id: tbl_data[1],
                                    division_code: tbl_data[2],
                                    division_name_th: tbl_data[3],
                                    division_name_en: tbl_data[4],
                                ...
                                if (key === 'view') {
                                    ...
                                    await $.Details(citem);
                                    await $.Edit(citem['division_id']);

                                } else if (key === 'delete') {

                                    await $.Details(citem);
                                    await $.Delete(citem['division_id']);
        ...
        $.Create = async function () {
            ...
            $('.btn-save_form').click(function (e) {
                ...
                $('#frm_data').parsley().on('form:submit', function () {
                    ...
                    citem.push({
                        division_code: $('#frm_data').find('#division_code').val(),
                        division_name_th: $('#frm_data').find('#division_name_th').val(),
                        division_name_en: $('#frm_data').find('#division_name_en').val(),
                    ...
                    $.ajax({
                        url: url_auth_sys_division_create,
                        type: 'POST',
                            ...
                            toastr.success('Save Successfully!', function () {
                                ...
                                setTimeout(function () {
                                    ...
                                    if (submit_action === "save_exit") {
                                        ...
                                        $('#division_code').val('');
                                        $('#division_name_th').val('');
                                        $('#division_name_en').val('');
        ...
        $.Details = async function (citem) {
            ...
            $('#division_code').val(citem['division_code']).prop('disabled', true);
            $('#division_name_th').val(citem['division_name_th']).prop('disabled', true);
            $('#division_name_en').val(citem['division_name_en']).prop('disabled', true);
        ...
        $.Edit = async function (item_id) {
            ...
            $('#division_name_th').prop('disabled', false);
            $('#division_name_en').prop('disabled', false);
            ...
            $('.btn-save_form').click(function (e) {
                ...
                $('#frm_data').parsley().on('form:submit', function () {
                    ...
                    fetch(url_auth_sys_division_update, {
        ...
        $.Delete = async function (item_id) {
            ...
            $('.btn-save_form').click(function (e) {
                ...
                $('#frm_data').parsley().on('form:submit', function () {
                    ...
                    fetch(url_auth_sys_division_delete, {
