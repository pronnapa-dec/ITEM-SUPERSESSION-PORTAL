...
const url_auth_sys_branch_create = url_api + '/v2/OrgSysBranchCreate';
const url_auth_sys_branch_update = url_api + '/v2/OrgSysBranchUpdate';
const url_auth_sys_branch_delete = url_api + '/v2/OrgSysBranchDelete';
const url_auth_sys_branch_get = url_api +'/v2/OrgSysBranchGet';
...
firebase.auth().onAuthStateChanged(async function (user) {
    ...
    if (user) {
        ...
        $.List = async function () {
            ...
            let url = new URL(url_auth_sys_branch_get);
                    ...
                    "initComplete": function (settings, json) {
                        $.contextMenu({
                            ...
                            callback: async function (key, options) {
                                ...
                                let citem = {
                                    branch_id: tbl_data[1],
                                    branch_code: tbl_data[2],
                                    branch_name_th: tbl_data[3],
                                    branch_name_en: tbl_data[4],
                                ...
                                if (key === 'view') {
                                    ...
                                    await $.Details(citem);
                                    await $.Edit(citem['branch_id']);

                                } else if (key === 'delete') {

                                    await $.Details(citem);
                                    await $.Delete(citem['branch_id']);
        ...
        $.Create = async function () {
            ...
            $('.btn-save_form').click(function (e) {
                ...
                $('#frm_data').parsley().on('form:submit', function () {
                    ...
                    citem.push({
                        branch_code: $('#frm_data').find('#branch_code').val(),
                        branch_name_th: $('#frm_data').find('#branch_name_th').val(),
                        branch_name_en: $('#frm_data').find('#branch_name_en').val(),
                    ...
                    $.ajax({
                        url: url_auth_sys_branch_create,
                        type: 'POST',
        ...
        $.Details = async function (citem) {
            ...
            $('#branch_code').val(citem['branch_code']).prop('disabled', true);
            $('#branch_name_th').val(citem['branch_name_th']).prop('disabled', true);
            $('#branch_name_en').val(citem['branch_name_en']).prop('disabled', true);
        ...
        $.Edit = async function (item_id) {
            ...
            $('#branch_name_th').prop('disabled', false);
            $('#branch_name_en').prop('disabled', false);
            ...
            $('.btn-save_form').click(function (e) {
                ...
                $('#frm_data').parsley().on('form:submit', function () {
                    ...
                    fetch(url_auth_sys_branch_update, {
        ...
        $.Delete = async function (item_id) {
            ...
            $('.btn-save_form').click(function (e) {
                ...
                $('#frm_data').parsley().on('form:submit', function () {
                    ...
                    fetch(url_auth_sys_branch_delete, {
