...
const url_auth_sys_company_create = url_api + '/v2/OrgSysCompanyCreate';
const url_auth_sys_company_update = url_api + '/v2/OrgSysCompanyUpdate';
const url_auth_sys_company_delete = url_api + '/v2/OrgSysCompanyDelete';
...
firebase.auth().onAuthStateChanged(async function (user) {
    ...
    if (user) {
                    ...
                    "initComplete": function (settings, json) {
                        $.contextMenu({
                            ...
                            callback: async function (key, options) {
                                ...
                                let citem = {
                                    company_id: tbl_data[1],
                                    company_code: tbl_data[2],
                                    company_name_th: tbl_data[3],
                                    company_name_en: tbl_data[4],
                                ...
                                if (key === 'view') {
                                    ...
                                    await $.Details(citem);
                                    await $.Edit(citem['company_id']);

                                } else if (key === 'delete') {

                                    await $.Details(citem);
                                    await $.Delete(citem['company_id']);
        ...
        $.Create = async function () {
            ...
            $('.btn-save_form').click(function (e) {
                ...
                $('#frm_data').parsley().on('form:submit', function () {
                    ...
                    citem.push({
                        company_code: $('#frm_data').find('#company_code').val(),
                        company_name_th: $('#frm_data').find('#company_name_th').val(),
                        company_name_en: $('#frm_data').find('#company_name_en').val(),
                    ...
                    $.ajax({
                        url: url_auth_sys_company_create,
                        type: 'POST',
        ...
        $.Details = async function (citem) {
            ...
            $('#company_code').val(citem['company_code']).prop('disabled', true);
            $('#company_name_th').val(citem['company_name_th']).prop('disabled', true);
            $('#company_name_en').val(citem['company_name_en']).prop('disabled', true);
        ...
        $.Edit = async function (item_id) {
            ...
            $('#company_code').prop('disabled', false);
            $('#company_name_th').prop('disabled', false);
            $('#company_name_en').prop('disabled', false);
            ...
            $('.btn-save_form').click(function (e) {
                ...
                $('#frm_data').parsley().on('form:submit', function () {
                    ...
                    fetch(url_auth_sys_company_update, {
        ...
        $.Delete = async function (item_id) {
            ...
            $('.btn-save_form').click(function (e) {
                ...
                $('#frm_data').parsley().on('form:submit', function () {
                    ...
                    fetch(url_auth_sys_company_delete, {
