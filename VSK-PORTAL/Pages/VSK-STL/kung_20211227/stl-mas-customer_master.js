                ...
                "initComplete": function (settings, json) {
                    ...
                    $.contextMenu({
                        ...
                        callback: function (key, options) {
                            ...
                            let citem = oTable_addr.row(this).data();
                            ...
                            if (key === 'view') {
                                ...
                                $.EditAddr(citem, cusitem);

                            } else if (key === 'delete') {

                                $.DeleteAddr(citem, cusitem);

                            } else if (key === 'trp') {

                                $.List_Delivery(citem, cusitem);
...
$.List_TRP = async function (customer_code) {

    let url = new URL(customer_setup_trp_get);

    url.search = new URLSearchParams({
        emmas_code: customer_code,
        record_status: '1',
        mode: 'Search'
    ...
    fetch(customer_detail + '?code=' + citem['code']).then(function (response) {
        ...
        if (result.length > 0) {
            ...
            $.each(result.data, function (key, val) {
                ...
                $('#customerinfo').find('#emmas_etel').val(val['etel']).prop('disabled', true);
                $('#customerinfo').find('#emmas_etran').val(val['etran']).prop('disabled', true);
                $('#customerinfo').find('#customer_grouprank').val(val['grouprank']).prop('disabled', true);
                $('#customerinfo').find('#emmas_ebranch').val(val['ebranch']).prop('disabled', true);
                $('#customerinfo').find('#emmas_efax').val(val['efax']).prop('disabled', true);
                ...
                $('#customerinfo').find('#emmas_eregdate').val(val['eregdate']).prop('disabled', true);
                $('#customerinfo').find('#emmas_eOwn3').val(val['eOwn3']).prop('disabled', true);
                $('#customerinfo').find('#emmas_eOwn0').val(val['eOwn0']).prop('disabled', true);
                $('#customerinfo').find('#customer_idcardno').val(val['customer_idcardno']).prop('disabled', true);
                $('#customerinfo').find('#emmas_edescript').val(val['edescript']).prop('disabled', true);
                $('#customerinfo').find('#emmas_eaddress').val(val['eaddress']).prop('disabled', true);
                $('#customerinfo').find('#emmas_etumbol').val(val['etumbol']).prop('disabled', true);
                $('#customerinfo').find('#emmas_eamphur').val(val['eamphur']).prop('disabled', true);
                $('#customerinfo').find('#emmas_eprovinc').val(val['eprovinc']).prop('disabled', true);
                $('#customerinfo').find('#emmas_ezip').val(val['ezip']).prop('disabled', true);
                $('#customerinfo').find('#customer_eaddress2').val(val['customer_eaddress2']).prop('disabled', true);
                $('#customerinfo').find('#customer_etumbol2').val(val['customer_etumbol2']).prop('disabled', true);
                $('#customerinfo').find('#customer_eamphur2').val(val['customer_eamphur2']).prop('disabled', true);
                $('#customerinfo').find('#customer_eprovinc2').val(val['customer_eprovinc2']).prop('disabled', true);
                $('#customerinfo').find('#customer_ezip2').val(val['customer_ezip2']).prop('disabled', true);
                ...
                $('#accountinfo').find('#emmas_egdis').val(val['egdis']).prop('disabled', true);
